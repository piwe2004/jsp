...
<section id="sub">
  ...
  <div>
    <aside>
      ...
      <ul class="side_menu">
        <li><a href="./notic.do"><img src="../img/sub_cate5_lnb1.png" onmouseover="this.src='../img/sub_cate5_lnb1_ov.png';" onmouseout="this.src='../img/sub_cate5_lnb1.png';"  alt=""></a></li>
        <li><a href="./menu.do"><img src="../img/sub_cate5_lnb2.png" onmouseover="this.src='../img/sub_cate5_lnb2_ov.png';" onmouseout="this.src='../img/sub_cate5_lnb2.png';"  alt=""></a></li>
        ...
        <li><a href="#"><img src="../img/sub_cate5_lnb4_ov.png" alt=""></a></li>
